...
public class Elevator extends SubsystemBase {
    ...
    //                                                            dear future programmers, change offset!!!!
    AnalogPotentiometer elevatorFrontPot = new AnalogPotentiometer(2,180,30); 
    AnalogPotentiometer elevatorBackPot = new AnalogPotentiometer(3, 180, 30);
...
addChild("ElevatorFrontPot",elevatorBackPot);
    ...
    public void ElevatorFrontOnlyUp(){
        // while (!frontTopLimiter.get()){
        //     Front.set(elevatorUpSpeed);
        // }
        // if (frontTopLimiter.get()){
        //     Front.set(0);
        //     return;
        // }
        while (elevatorFrontPot.get()<40){
             Front.set(elevatorUpSpeed);
        }
        while (elevatorFrontPot.get()>=40) {
            Front.set(0);
    ...
    public void ElevatorFrontOnlyDown(){
        // while (!frontBottomLimiter.get()){
        //     Front.set(elevatorDownSpeed);
        // }
        // if (frontBottomLimiter.get()){
        //     Front.set(0);
        //     return;
        // }
        while (elevatorFrontPot.get()>0){
             Front.set(elevatorDownSpeed);
        }
        while(elevatorBackPot.get()<=0){
            Front.set(0);
            return;
        }
    }
    ...
    public void ElevatorBackOnlyUp(){
        // while (!backTopLimiter.get()){
        //     Back.set(elevatorUpSpeed);
        // }
        // if (backTopLimiter.get()){
        //     Back.set(0);
        //     return;
        // }
        while (elevatorBackPot.get()<40){
            Back.set(elevatorUpSpeed);
        }
        while (elevatorBackPot.get()>=40) {
            Back.set(0);
    ...
    public void ElevatorBackOnlyDown(){
        // while (!backBottomLimiter.get()){
        //     Back.set(elevatorDownSpeed);
        // }
        // if (backBottomLimiter.get()){
        //     Back.set(0);
        //     return;
        // }
        while (elevatorFrontPot.get()>0){
    ...
    public void ElevatorBalance(){
        ...
        if (elevatorFrontPot.get()>0) {
            Front.set(elevatorDownSpeed);
            return;
        }
        if (elevatorBackPot.get()<=0) {
            Back.set(0);
            return;
        }
        }
    ...
    public void ElevatorStart(){
        while (elevatorFrontPot.get()!=40){
            if (elevatorFrontPot.get()<39 && elevatorFrontPot.get()>41) {
                Front.set(elevatorUpSpeed);
            }
            if (elevatorFrontPot.get()>40) {
                Front.set(elevatorDownSpeed);
            }
        }
        if (elevatorFrontPot.get()>=39 && elevatorFrontPot.get()<=41) {
    ...
    public void ElevatorMidPreset(){
        while (elevatorFrontPot.get()>19 && elevatorFrontPot.get()<21){
            if (elevatorFrontPot.get()<20) {
                Front.set(elevatorUpSpeed);
            }
            if (elevatorFrontPot.get()>20) {
                Front.set(elevatorDownSpeed);
        ...
        while (elevatorBackPot.get()>19 && elevatorBackPot.get()<21){
            if (elevatorBackPot.get()<20) {
                Back.set(elevatorUpSpeed);
            }
            if (elevatorBackPot.get()>20) {
                Back.set(elevatorDownSpeed);
    ...
    public void ElevatorPickUpPreset(){
        // Front.set(TalonFXControlMode.Position,0);
        // Back.set(TalonFXControlMode.Position,5);
        while (elevatorFrontPot.get()>19 && elevatorFrontPot.get()<21){
            if (elevatorFrontPot.get()<20) {
                Front.set(elevatorUpSpeed);
            }
